...
title: 用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？
url: https://mp.weixin.qq.com/s?__biz=MzkwNjYzMTEyMg==&mid=2247492651&idx=1&sn=4bd1f29073e4cd9c8708873feed48319
---

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/001.png)
...
如果，上面的文字描述没看懂也没关系。接下来，笔者将结合代码进一步说明。
...
第一个函数，主要是获取数据，然后调用cal\_factors函数（低11-14行）完成每日因子的计算，最后将其拼接为一个dataframe。

这里展示的是第二种因子的计算代码，如果是第三种或第四章的话，需要注释掉第17行，然后将6-8行替换为如下内容。
...
这个函数对同一个交易日的因子、行业和市值数据进行拼接，然后调用\_\_cal\_factors\_\_方法（第7行）计算因子。
...
这里第8行需要改动一下，如果是第三种或第四种因子，这里的绝对值需要去掉。

当然，不去掉也是可以的，那就是另外的因子了，有点类似均值距离化的操作了。写到这里，笔者决定将这两个因子也纳入进来，一共是六个因子，它们就用abnormal\_rtn\_dis和group\_abnormal\_rtn\_dis来表示。

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/002.png)

**因子评价**

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/003.png)
...
![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/004.png)

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/005.png)

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/006.png)

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/007.png)

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/008.png)

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/009.png)

**02**

**回归分析**

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/010.png)

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/011.png)

**03**

**换手率分析**

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/012.png)

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/013.png)

**04**

**收益分析**

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/014.png)

只看这个分层回测结果，肯定会有人说，它依旧不是很好。

但是，当你看了abnormal\_rtn的分层回测结果之后，你就会发现这个神奇的魔法真的有它的神奇之处。

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/015.png)
...
![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/016.png)

**- *END* -**

![Image](images/2025-12-11_用神奇的魔法优化最大异常日收益率，神奇依旧存在吗？/017.png)