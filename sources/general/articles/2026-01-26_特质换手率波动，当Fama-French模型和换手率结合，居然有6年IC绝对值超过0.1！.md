...
author: 量化拯救散户
date: '2026-01-26'
fetched_at: '2026-05-26T09:56:04'
title: 特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！
url: https://mp.weixin.qq.com/s?__biz=MzkwNjYzMTEyMg==&mid=2247494417&idx=1&sn=1f4e922ded0caf0123a0ca22530013d5
---

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/MA6hRUd7yGsJRN60JUnuBypnOG4OhBU5On0btJLWl0XAyMQjmU2pU3AYmPCL0nxrlCZWm4HF26G1EX9KtADxxA/640?wx_fmt=gif&from=appmsg)
...
第一段代码，主要是读取数据，然后调用两个不同的方法分别计算回归过程中的解释变量（cal\_premium）和计算残差波动（cal\_resi）。
...
这段代码就是将解释变量和被解释变量拼接在一起，然后去掉nan值进行时序回归，并计算残差的波动率。

这段代码是可以优化的，因为所有标的的解释变量都是一样的。因此，对于过去21个交易日的换手率没有nan值的标的可以进行批量计算。
...
![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/001.png)
...
![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/002.png)

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/003.png)

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/004.png)

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/005.png)

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/006.png)

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/007.png)
...
![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/008.png)

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/009.png)

**03**

**换手率分析**

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/010.png)

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/011.png)

**04**

**收益分析**

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/012.png)

![](images/2026-01-26_特质换手率波动，当Fama-French模型和换手率结合，居然有6年IC绝对值超过0.1！/013.png)
