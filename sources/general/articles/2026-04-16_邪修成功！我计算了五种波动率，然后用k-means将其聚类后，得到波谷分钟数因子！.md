...
author: 量化拯救散户
date: '2026-04-16'
fetched_at: '2026-05-26T09:41:01'
title: 邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！
url: https://mp.weixin.qq.com/s?__biz=MzkwNjYzMTEyMg==&mid=2247496194&idx=1&sn=0d718abb4aa0818591a87b1bd9e4d9e8
---

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/cvcTnuxE6ibaLXia3bHiaRaFmEsKQAJJPn3e0J32u4lMYZOqY3zyibI9MrDAhutvswgo0ibibcHjGWu52nsuxKqpCpibiaXeblHyfbK5LkicqTRzZDsg/640?wx_fmt=gif&from=appmsg)
...
第8-14行，计算更优波动率，这个概念是方正证券的曹春晓老师提出的。

第15-16行，计算分钟收益率的5标准差。

第17-28行，计算sigma\_p、sigma\_gk和sigma\_rs，完全是按照公式来的，没什么需要特别说明的。

第30-34行，调用run\_kmeans方法，对每个标的的波动率进行聚类。
...
这里需要的就是第6-9行，根据聚类中心的情况来修改label。

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/001.png)
...
![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/002.png)

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/003.png)

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/004.png)

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/005.png)

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/006.png)

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/007.png)
...
![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/008.png)

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/009.png)

**03**

**换手率分析**

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/010.png)

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/011.png)

**04**

**收益分析**

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/012.png)

![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/013.png)
...
![](images/2026-04-16_邪修成功！我计算了五种波动率，然后用k-means将其聚类后，得到波谷分钟数因子！/014.png)

**- *END* -**

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/cvcTnuxE6ibZicgiaqtsZDwdqnvl1iaEQ5QdFYbzeS58fP0paLWex2FOgLpBu1bbPpicesLysnParyb1Lp2pv4sfIKHDowibT7aicHdksJKkW24oDc/640?wx_fmt=gif&from=appmsg)