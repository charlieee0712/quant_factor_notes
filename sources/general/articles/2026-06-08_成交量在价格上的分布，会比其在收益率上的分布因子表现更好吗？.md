...
author: 量化拯救散户
date: '2026-06-08'
fetched_at: '2026-06-21T06:10:01'
title: 成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？
url: https://mp.weixin.qq.com/s?__biz=MzkwNjYzMTEyMg==&mid=2247497167&idx=1&sn=c6b45d36e4dda278266ffec7d402ab9c
---

![](https://mmbiz.qpic.cn/mmbiz_gif/cvcTnuxE6ibbUsjodEIdmBS7WmjVbxzOn2FVgl9Oke2ia6N7BCXM5mMuEGt8GktF1al63YdgfyZhCnHibkiaZFFs9c1n3P4AaAdy1ic5yprSiaG7I/640?wx_fmt=gif&from=appmsg)
...
第一段代码主要就是读取数据，然后遍历每一个标的并调用cal\_factor方法计算因子（第9-11行）。
...
第8-20行，计算每一组的价格的成交量之和。其中，18-19行是为了获取收盘价对应的序号。

第21-22行，对于存在涨停的情况，可能分不了10组，就对后面的数据进行补零。补零的顺序不会影响v\_p\_skewness的计算，基本上也不会影响v\_p\_reversal的计算，因为此时POC和C很有可能是相等的。

第23-24行，计算v\_p\_skewness。

第25-33行，计算POC。

第34-37行，计算v\_p\_reversal。
...
![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/001.png)
...
![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/002.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/003.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/004.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/005.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/006.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/007.png)
...
![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/008.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/009.png)

**03**

**换手率分析**

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/010.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/011.png)

**04**

**收益分析**

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/012.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/013.png)

![](images/2026-06-08_成交量在价格上的分布，会比其在收益率上的分布因子表现更好吗？/014.png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/cvcTnuxE6ibaMnhNardvbO8DFmdiak0ibicBGJWDMFn7aMaNtUyDB1ib3xLEWicic2bDC2XjJsP0UGMkRiag3wkZrZImfF7d86MM1S5y3fbRSUNzZuI/640?wx_fmt=gif&from=appmsg)