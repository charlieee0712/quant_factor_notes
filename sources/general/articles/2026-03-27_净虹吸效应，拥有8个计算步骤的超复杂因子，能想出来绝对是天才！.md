...
author: 量化拯救散户
date: '2026-03-27'
fetched_at: '2026-05-26T09:41:56'
title: 净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！
url: https://mp.weixin.qq.com/s?__biz=MzkwNjYzMTEyMg==&mid=2247495737&idx=1&sn=0661c0105e13450dc604544b9c410cc1
---

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/cvcTnuxE6ibYlgG3QOtYbZ1XIh5ibpcxluPcR3sIickjAJunsX2eeySKSLP1w4uYRuPmMWOMnNYI8Qk4h8Ls6O92eXjbj0Q6mUHwuA67ZeZ9jA/640?wx_fmt=gif&from=appmsg)
...
![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/001.png)
...
第12-14行，计算收益率修正的成交额放大倍数。

第15行，计算市场炒作热度。

第16-17行，计算热度时间。

第18行，计算个股每分钟主卖成交额占比和市场每分钟主卖成交额占比。

第19行，计算虹吸效应因子。

第20-26行，计算虹吸回流综合效应因子。其中，第20-25行，是计算回流时刻的个股每分钟主卖成交额占比和市场每分钟主卖成交额占比。
...
这一次，笔者在计算主卖概率的时候，相对于[主买成交特异性，用分钟数据强行构造主买数据，能行吗？](https://mp.weixin.qq.com/s?__biz=MzkwNjYzMTEyMg==&mid=2247495622&idx=1&sn=53bc4a83c3269657abcfcff21f50a56f&scene=21#wechat_redirect)进行了优化。整个思路是一致的，只不过对收盘价最高价和最低价相等的情况进行了特殊处理。

第3-5行，是为了防止收盘价高于最高价或者低于最低价的情况。

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/002.jpg)

因为笔者发现有一条数据是这样的。第3-4行，就是为了防止这种类似无穷大的情况。

对于这种情况，最高价=最低价的情况，用分钟收益率来辅助判断，分钟收益率大于0，全为主买，否则全为主卖。代码6-8行，实现的就是这个功能。

第9行，计算每个标的每分钟的主卖成交额。

第10行，计算市场每分钟主卖成交额。

第11-16行，就是针对1分钟k线和5分钟k线的不同处理了。
...
回归这个没有什么需要特殊说明的了，就贴一个代码了。

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/003.png)

**因子评价**

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/004.png)
...
![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/005.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/006.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/007.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/008.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/009.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/010.png)
...
![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/011.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/012.png)

**03**

**换手率分析**

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/013.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/014.png)

**04**

**收益分析**

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/015.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/016.png)

这个因子的分层回测结果展现出了两头好中间差的趋势。

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/017.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/018.png)
...
![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/019.png)

![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/020.png)
...
![](images/2026-03-27_净虹吸效应，拥有8个计算步骤的超复杂因子，能想出来绝对是天才！/021.png)

**- *END* -**

![](https://mmbiz.qpic.cn/mmbiz_gif/cvcTnuxE6ibYOC3HZQoXPARoOQcqJlK5nEgr5K8T2mshDAbaqXPOy0MEvsO4ZXibdkzQfxkhy3TkKn7MNQkoVgk2BiakKic5OeND1MWoMrmeYgA/640?wx_fmt=gif&from=appmsg)