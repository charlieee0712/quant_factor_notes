...
author: 量化拯救散户
date: '2025-12-22'
fetched_at: '2026-06-22T02:16:28'
title: 时间重心偏离，一个需要进行三次截面回归的因子！
url: https://mp.weixin.qq.com/s?__biz=MzkwNjYzMTEyMg==&mid=2247493107&idx=1&sn=3a20f683473ea9915b7b008eaa3697b6
---

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/MA6hRUd7yGu1Ca2HNYgj7gfAzKnBbOWwzsP5WtiaqShyRaZJFtj8vS76vCDtDnoOEXVgbafEYxv78iad7F1TG2Hg/640?wx_fmt=png&from=appmsg)
...
这段代码对应计算步骤中的第一步，主要计算了平均涨幅、平均跌幅、第一个30分钟的收益率和第二个30分钟的收益率。
...
这段代码主要是读取涨跌幅时间重心这两个因子，然后计算隔夜收益率，最后调用cal\_factors来计算时间重心偏离（TCD）因子。

第2-5行，是调用process\_single\_day来计算一些需要用到分钟级数据的因子。
...
第11-12行，将res这个dataframe转换为BaseDataLoader的数据结构。
...
第2-12行，获取截面上的各因子值，然后去掉有nan的情况。

第13-14行，如果截面上所有因子不为nan的标的不超过10个，就返回一个空的dataframe。
...
最后一段代码，就是进行线性回归然后计算残差了。

这里需要注意的是，输入 的数据是一个ndarry，最后一列的数据是y，其他列的数据是x。

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/001.png)

**因子评价**

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/002.png)
...
![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/003.png)

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/004.png)

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/005.png)

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/006.png)

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/007.png)

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/008.png)

**02**

**回归分析**

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/009.png)

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/010.png)

**03**

**换手率分析**

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/011.png)

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/012.png)

**04**

**收益分析**

![](images/2025-12-22_时间重心偏离，一个需要进行三次截面回归的因子！/013.png)
